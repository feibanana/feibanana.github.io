<?php
	...
	$send_name      = "Notícias FEIBANANA";		// Replace your name
	$send_title     = "Notícias FEIBANANA";		// Replace email sent title
	$send_address   = "noticias@feibanana.com.br";	// Replace your email address
	
	$smtp_address   = "noticias@feibanana.com.br";		// Replace your email address
	$smtp_password	= "iu4004iu04@";				// Replace your email password
